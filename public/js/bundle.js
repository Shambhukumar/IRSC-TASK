...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(firstname, lastname, email, password, passwordConfirm, role) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              alert("Account Created Successfully!!"); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(email, password, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            alert("YOU ARE NOT ".concat(role.toUpperCase(), " USER PLEASE CLICK IN TO ").concat(role == "customer" ? "HOTEL" : "CUSTOMER", " LOGIN"));
            _context.next = 8;
            return (0, _axios.default)({
              method: "GET",
              url: "/users/logout"
...
var logouthtml = function logouthtml() {
  var markup = "\n  <ul class=\"cred\">\n    <li class=\"Header_links--el Header_links--authentication--login\">\n    <a href=\"#\" id=\"login\">Login</a>\n    </li>\n    <li class=\"Header_links--el Header_links--authentication--Register\">\n    <a href=\"#\" id=\"register\">Register</a>\n    </li>\n  <ul";
  var ch = document.querySelector(".cred");
  ch.parentNode.removeChild(ch);
  var dh = document.querySelector(".filter-com");
  dh.parentNode.removeChild(dh);
  document.querySelector(".Header_links--authentication").insertAdjacentHTML("beforeend", markup);
};
},{"axios":"../../node_modules/axios/index.js"}],"search.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(date, state) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "/hotel/Date/".concat(date, "/city/").concat(state)
            });
  ...
  return function searchres(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var cardCreation = function cardCreation(card) {
  var markup = "\n      <div class=\"card\">\n      <div class=\"location-details\">\n        <h2>".concat(card.name, "</h2>\n        <h3>").concat(card.city, "</h3>\n      </div>\n      <div class=\"logo\"><img src=\"./img/hotel-logo-design-png-2.png\" alt=\"\"></div>\n      <div class=\"date\">\n        <h2>").concat(card.date.slice(0, 10), "<h2>\n      </div>\n      <div class=\"price\">\n        <h2>Starts @ ").concat(card.price, "/-<h2>\n      </div>\n      <button class=\"button--login\">Book Now <i class=\"fa fa-arrow-circle-o-right\" aria-hidden=\"true\"></i></button>\n    </div>\n  ");
  document.querySelector(".hotel__cards").insertAdjacentHTML("afterbegin", markup);
};

var cardhtml = function cardhtml(card) {
  removeCard();
  ...
  if (card.length === 0) {
    document.querySelector(".hotel__cards").insertAdjacentHTML("afterbegin", empty);
  }
};
...
document.addEventListener("click", function (e) {
  var bgmodel = document.querySelector(".bg-modal").classList;
  var bgmodelreg = document.querySelector(".bg-modal--register").classList;
  var customer = document.getElementById("customer").classList;
  var hotel = document.getElementById("hotel").classList;
  var customerreg = document.querySelector(".customer").classList;
  var hotelreg = document.querySelector(".hotel").classList;

  if (e.target.id == "logout") {
    (0, _search.searchres)(false, false);
    (0, _login.logout)();
  }
...
window.signUP = function () {
  ...
  var role = document.querySelector(".selected--reg").classList[0];

  if (!(pass === conpass)) {
    return alert("Please Enter Same Password For Password And Confirm Password");
  } // console.log(fname,role);


  (0, _signup.signup)(fname, lname, email, pass, conpass, role);
